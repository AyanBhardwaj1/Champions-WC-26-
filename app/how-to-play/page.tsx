...
import { ArrowRight, CircleDot, Dices, ListChecks, Trophy } from "lucide-react";
...
export default function HowToPlayPage() {
  return <main className="info-page"><section className="info-hero shell"><span className="eyebrow">The rules</span><h1>Eleven spins.<br />Eight wins.</h1><p>Champions (WC 26) is a draft-and-simulate football game built around the complete history of the men’s World Cup.</p></section><section className="shell rules-stack">
    {[
      ...
      ["03", ListChecks, "Replace a 2026 nation", "Once all 11 slots are filled, choose one of the 48 World Cup 2026 teams. Your custom XI takes that team’s place in its real group."],
      ["04", Trophy, "Survive the tournament", "Play three group matches. Finish in the top two—or as one of the eight best third-placed teams—to reach the Round of 32. Then win five knockout games."],
