...
export default function DisclaimerPage() {
  return <main className="info-page"><section className="info-hero shell"><span className="eyebrow">Transparency</span><h1>Unofficial.<br />Auditable.</h1><p>Champions (WC 26) is an independent fan-made project built for entertainment and football-history exploration.</p></section><section className="shell legal-grid">
    ...
    <article><h2>Independent ratings</h2><p>Player and team ratings are an independent mathematical interpretation of public data. They are not official FIFA or EA Sports ratings and do not claim to measure a player’s full career quality. See <code>RATINGS.md</code> in the project for the exact formula and limitations.</p></article>
